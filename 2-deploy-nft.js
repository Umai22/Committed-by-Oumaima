...
async function run(runtimeEnv, deployer) {
    ...
    await Promise.all(assets.map(async (asset) => {
        ...
        const metadata = {
            ...
            image: `ipfs://${result.IpfsHash}/Users/hp/github-classroom/Algo-Foundry/arc3-nft-28091999/arc3-nft-28091999/assets/nft/${asset.file}`,
            image_integrity: `sha256-${integrity.base64}`,
            image_mimetype: asset.image_mimetype,
            properties: {
                file_url: `https://gateway.pinata.cloud/ipfs/${result.IpfsHash}/Users/hp/github-classroom/Algo-Foundry/arc3-nft-28091999/arc3-nft-28091999/assets/nft/${asset.file}`,
